...
final class allembed_main_element {
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			...
			esc_html__( '"%1$s" requires "%2$s" to be installed and activated.', 'allembed' ),
			'<strong>' . esc_html__( 'Media Player Addon', 'allembed' ) . '</strong>',
			'<strong><a href="https://wordpress.org/plugins/elementor/">' . esc_html__( 'Elementor', 'allembed' ) . '</a></strong>'
		);
