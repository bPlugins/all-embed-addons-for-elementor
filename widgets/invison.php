 ...
 * @since 1.0.0
 */
class invison_addon extends Widget_Base {
  ...
  //Vedio player Content Settings
    ...
    $this->start_controls_section(
        'invison_ttabb', [
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .invisionn iframe' => 'max-width: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .invisionn iframe' => 'height: {{SIZE}}{{UNIT}}',
				],
			]
		);
	...
	protected function render() {
        ...
        $invison_link    = $settings['invison_link'];
       
	
	?>
	
   <div class="invisionn">
      <iframe src="<?php echo esc_url($invison_link); ?>" frameborder="0" allowfullscreen></iframe>
  </div>
