 ...
 * @since 1.0.0
 */
class pinterest_addon extends Widget_Base {
  ...
  //Vedio player Content Settings
    ...
    $this->add_control(
        ...
        [
            ...
            'default' =>'https://assets.pinterest.com/ext/embed.html?id=595319644497459300',
    ...
    $this->start_controls_section(
        'pinterest_ttabb', [
           ...
           $this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .pin iframe' => 'max-width: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .pin iframe' => 'height: {{SIZE}}{{UNIT}}',
				],
			]
		);
	...
	<div class="pin"><iframe src="<?php echo esc_url($pinterest_link); ?>" frameborder="0" scrolling="no" ></iframe></div>
