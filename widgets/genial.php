 ...
 * @since 1.0.0
 */
class genial_addon extends Widget_Base {
  ...
  //Vedio player Content Settings
    ...
    $this->add_control(
        ...
        [
            ...
            'default' =>'https://view.genial.ly/6093968b1be844100148450a',
    ...
    $this->start_controls_section(
        'genial_ttabb', [
          ...
          $this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .geniall iframe' => 'max-width: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .geniall iframe' => 'height: {{SIZE}}{{UNIT}}',
				],
			]
		);
	...
	protected function render() {
        ...
        $genial_link    = $settings['genial_link'];
      
	
	?>
	<div class="geniall">
	   <iframe frameborder="0" src="<?php echo esc_url($genial_link); ?>" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all">
