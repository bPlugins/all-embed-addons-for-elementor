 ...
 * @since 1.0.0
 */
class twitch_addon extends Widget_Base {
  ...
  //Vedio player Content Settings
    ...
    $this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .twitch iframe' => 'max-width: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .twitch iframe' => 'height: {{SIZE}}{{UNIT}}',
				],
			]
		);
	...
	protected function render() {
        ...
        $twitch_link    = $settings['twitch_link'];
     
	?>

  <div class="twitch"><iframe src="<?php echo esc_url($twitch_link); ?>" frameborder="0" allowfullscreen="true" scrolling="no"></iframe></div>
